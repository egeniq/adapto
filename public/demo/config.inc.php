<?php
  ...
  /**
   * Cache table meta data and compiled metan entity code.
   *
  ...
  $config_auth_userentity    = "lesson5.employee"; // module.entityname
 ...
 // -------------- DOCUMENT WRITER CONFIGURATION ---------------
  ...
  // See: http://www.achievo.org/wiki/Adapto_Cache
