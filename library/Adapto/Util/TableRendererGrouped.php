 ...
 * @subpackage utils
 */
class Adapto_Util_TableRendererGrouped extends Adapto_TableRenderer
{
    /**
     ...
     * @access private
     */
    public $m_currentRow = 0; // defaulted to public
     ...
     * @return Adapto_Util_TableRendererGrouped
     * @access public
     */
    ...
    function _renderRowGroupHeader($group, $width)
    {
        ...
        if (!isset($group['header'])) {
            ...
            $header = '<tr><th class="groupheader" colspan="' . $width . '">' . $this->_renderValue($group['rows'][0][0]) . '</th></tr>';
