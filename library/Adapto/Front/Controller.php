 ...
 * @subpackage front
 */
class Adapto_Front_Controller implements ArrayAccess
{
     ...
     * @param Adapto_Front_Controller $parent parent controller
     * @return Adapto_Front_Controller the controller
     */
     ...
     *
     * @return Adapto_Front_Controller current controller instance
     */
     ...
     *
     * @param Adapto_Front_Controller $controller current controller instance
     */
     ...
     * @param string $action
     * @param Adapto_Front_Controller $parent 
     */
     ...
     *
     * @return Adapto_Front_Controller parent
     */
     ...
     *
     * @return Adapto_Front_Controller root
     */
    ...
    protected function getActionCacheFile()
    {
        ...
        $file = new Adapto_TmpFile($path . '/' . $filename);
        return $file;
    }
    ...
    protected function storeInActionCache()
    {
        ...
        $data = array('result' => $this->m_result, 'headers' => $this->m_headers, 'styleSheets' => $this->m_styleSheets, 'styleCodes' => $this->m_styleCodes,
                'scriptFiles' => $this->m_scriptFiles, 'scriptCodes' => $this->m_scriptCodes);
    ...
    protected function handleRequest($request)
    {
        try {
            ...
            $this->m_request = new Adapto_DataHolder($request);
    ...
    {
        return new Adapto_DataHolder($_SESSION);
    }
