<?php
   ...
   * @subpackage security
   */
  class Adapto_Security_UrlVault
  {
    /**
     ...
     * @var array
     */
    public $m_vault; // defaulted to public
     ...
     * @var int
     */
    public $m_vaultsize = 100; // defaulted to public

    /**
     * Constructor. Do not use directly, Adapto_Security_UrlVault is a singleton.
     * @access private
     * @return Adapto_Security_UrlVault
     */
    ...
    function &getInstance()
    {
      ...
      if ($s_instance==NULL)
      {
        $s_instance = new Adapto_Security_UrlVault();
      }
