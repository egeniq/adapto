...
/**
 * Flags for the Adapto_Attribute_Ip
 */
...
/**
 * The Adapto_Attribute_Ip can be used to let the user enter IP(v4) addresses.
 ...
 * @subpackage attributes
 */
class Adapto_Attribute_Ip extends Adapto_Attribute
{
    /**
     * Constructor.
     *
