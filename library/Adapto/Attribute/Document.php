<?php
/**
 * Adapto_Attribute_Document class file
 *
 * @package adapto
...
/**
 * DocumentAttribute class for adding document generation functionality to an entity
 *
 * @author guido <guido@ibuildings.nl>
 * @package adapto
 * @subpackage attributes
 */
class Adapto_Attribute_Document extends Adapto_DummyAttribute
{

    /**
     * Adapto_Attribute_Document constructor
     *
            ...
            if (is_file($path . "/" . $entry)) // todo: && check of tie een open office extensie heeft
 {
        ...
        $onclickscript = 'window.location="' . session_url(dispatch_url($module . "." . $entity, "document", array("atkselector" => $selector)), SESSION_DEFAULT)
                . '&atkdoctpl="+this.form.atkdoctpl.value;';
