...
include_once(Adapto_Config::getGlobal("atkroot") . "atk/utils/class.atkstringparser.inc");

/**
 * The Adapto_Attribute_FileWriter is an attribute that reads data from / saves 
 ...
 *
 */ 
class Adapto_Attribute_FileWriter extends Adapto_TextAttribute
{
    public $m_filename; // defaulted to public
    ...
    function value2db($record)
    {
        ...
        $parser = new Adapto_StringParser($this->m_filename);
