...
/**
 * The Adapto_Attribute_Url class represents a field containing URLs.
 *
 ...
 * @subpackage attributes
 */
class Adapto_Attribute_Url extends Adapto_Attribute
{
    public $m_accepts_url_flag = 0; // defaulted to public

    public $m_newWindow = false; // defaulted to public
    public $m_allowWrap = false; // defaulted to public
    public $m_stripHttp = false; // defaulted to public
