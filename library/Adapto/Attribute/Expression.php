...
/**
 * With the Adapto_Attribute_Expression class you can select arbitrary SQL expressions
 ...
 * @subpackage attributes
 */
class Adapto_Attribute_Expression extends Adapto_Attribute
{
    public $m_searchType = "string"; // defaulted to public
    public $m_expression; // defaulted to public
