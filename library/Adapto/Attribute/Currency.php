...
/**
 * The Adapto_Attribute_Currency can be used for money values.
 *
 ...
 *
 */
class Adapto_Attribute_Currency extends Adapto_NumberAttribute
{
    public $m_currencysymbol; // defaulted to public
    ...
    public function __construct($name, $flags = 0, $size = 10, $currencysymbol = "", $decimals = 2, $decimalseparator = "", $thousandsseparator = "")
    {
