 ...
 * @subpackage attributes
 */
class Adapto_Attribute_Country extends Adapto_ListAttribute
{
    public $m_countries = array(); // defaulted to public
    public $m_europe_countries = array('AL', 'AT', 'BE', 'BA', 'BG', 'HR', 'CY', 'CZ', 'DK', 'DE', 'FI', 'FR', 'GB', 'GR', 'HU', 'IE', 'IT', 'LI', 'LU', 'MC', // defaulted to public
            'NL', 'NO', 'PL', 'PT', 'RO', 'SK', 'SI', 'ES', 'SE', 'CH', 'TR');
    public $m_benelux_countries = array('NL', 'BE', 'LU'); // defaulted to public

    public $m_world_countries_shortlist = array('AT', 'BE', 'CA', 'DK', 'FI', 'FR', 'DE', 'GR', 'IE', 'IT', 'LU', 'NL', 'PT', 'ES', 'SE', 'GB', 'US'); // defaulted to public

    public $m_world_countries = array('AF', 'AL', 'DZ', 'AS', 'AD', 'AO', 'AI', 'AQ', 'AG', 'AR', 'AM', 'AW', 'AU', 'AT', 'AZ', 'BS', 'BH', 'BD', 'BB', 'BY', // defaulted to public
            'BE', 'BZ', 'BJ', 'BM', 'BO', 'BA', 'BW', 'BV', 'BR', 'IO', 'BN', 'BG', 'BF', 'BI', 'BT', 'KH', 'CM', 'CA', 'CV', 'KY', 'CF', 'TD', 'CL', 'CN',
            'CX', 'CC', 'CO', 'KM', 'CG', 'CK', 'CR', 'HR', 'CU', 'CY', 'CZ', 'DK', 'DE', 'DJ', 'DM', 'DO', 'TP', 'EC', 'EG', 'SV', 'GQ', 'EE', 'ET', 'FK',
            'FO', 'FJ', 'FI', 'FR', 'FX', 'TF', 'GA', 'GM', 'GE', 'GH', 'GI', 'GB', 'GR', 'GL', 'GD', 'GP', 'GU', 'GT', 'GN', 'GW', 'GY', 'GF', 'HT', 'HM',
            'HN', 'HK', 'HU', 'IS', 'IN', 'ID', 'IR', 'IQ', 'IE', 'IL', 'IT', 'CI', 'JM', 'JP', 'JO', 'KZ', 'KE', 'KG', 'KI', 'KP', 'KR', 'KW', 'LA', 'LV',
            'LB', 'LS', 'LR', 'LY', 'LI', 'LT', 'LU', 'MO', 'MG', 'MW', 'MY', 'MV', 'ML', 'MT', 'MH', 'MQ', 'MR', 'MU', 'MX', 'FM', 'MD', 'MC', 'MN', 'MS',
            'MA', 'MZ', 'MM', 'NA', 'NR', 'NL', 'AN', 'NP', 'NC', 'NZ', 'NI', 'NE', 'NG', 'NU', 'NF', 'MP', 'NO', 'OM', 'PK', 'PW', 'PA', 'PG', 'PY', 'PE',
            'PH', 'PN', 'PL', 'PF', 'PT', 'PR', 'QA', 'RE', 'RO', 'RU', 'RW', 'LC', 'WS', 'SM', 'SA', 'SN', 'SC', 'SL', 'SG', 'SK', 'SI', 'SB', 'SO', 'ZA',
            'ES', 'LK', 'SH', 'PM', 'ST', 'KN', 'VC', 'SD', 'SR', 'SJ', 'SZ', 'SE', 'CH', 'SY', 'TJ', 'TW', 'TZ', 'TH', 'TG', 'TK', 'TO', 'TT', 'TN', 'TR',
            'TM', 'TC', 'TV', 'UM', 'UG', 'UA', 'AE', 'GB', 'US', 'UY', 'UZ', 'VU', 'VA', 'VE', 'VN', 'VG', 'VI', 'WF', 'EH', 'YE', 'ZR', 'ZM', 'ZW');

    public $m_custom_countries = array(); // defaulted to public
     ...
     *
     * <b>Example:</b>
     *        $this->add(new Adapto_Attribute_Country("zipcode","world","","",AF_OBLIGATORY));
    ...
    public function __construct($name, $switch = "world", $optionArray = "", $valueArray = "", $flags = 0, $defaulttocurrent = true)
    {
    ...
    function setList($countries)
    {
        ...
        foreach ($countries as $countryIso) {
            ...
            if (in_array($countryIso, $this->m_world_countries)) {
                ...
                atkwarning('Adapto_Attribute_Country: setList: ' . $countryIso . ' is a unknown country and will be ignored');
            }
        }
    ...
    {
        $this->m_country["AL"]["nl"] = Adapto_html_entity_decode("Albani&euml;");
        ...
        $this->m_country['BE']['nl'] = Adapto_html_entity_decode("Belgi&euml;");
        $this->m_country['BE']['de'] = "Belgien";
        $this->m_country['BE']['en'] = "Belgium";

        $this->m_country["BA"]["nl"] = Adapto_html_entity_decode("Bosni&euml;-Herzegovina");
        ...
        $this->m_country["CZ"]["nl"] = Adapto_html_entity_decode("Tsjechi&euml;");
        ...
        $this->m_country['GB']['nl'] = Adapto_html_entity_decode("Groot-Brittanni&euml;");
        ...
        $this->m_country["HR"]["nl"] = Adapto_html_entity_decode("Kroati&euml;");
        ...
        $this->m_country['IT']['nl'] = Adapto_html_entity_decode("Itali&euml;");
        ...
        $this->m_country["RO"]["nl"] = Adapto_html_entity_decode("Roemeni&euml;");
        ...
        $this->m_country["SK"]["nl"] = Adapto_html_entity_decode("Slowakij&euml;");
        $this->m_country["SK"]["de"] = "Slovak Republic";
        $this->m_country["SK"]["en"] = "Slovak Republic";

        $this->m_country["SI"]["nl"] = Adapto_html_entity_decode("Sloveni&euml;");
        ...
        $this->m_country['YU']['nl'] = Adapto_html_entity_decode("Joegoslavi&euml;");
    ...
    function fillWorldCountriesArray()
    {
        ...
        $this->m_country["AR"]["nl"] = Adapto_html_entity_decode("Argentini&euml;");
        $this->m_country["AR"]["de"] = "Argentina";
        $this->m_country["AR"]["en"] = "Argentina";

        $this->m_country["AM"]["nl"] = Adapto_html_entity_decode("Armeni&euml;");
        ...
        $this->m_country["AU"]["nl"] = Adapto_html_entity_decode("Australi&euml;");
        ...
        $this->m_country["BR"]["nl"] = Adapto_html_entity_decode("Brazili&euml;");
        ...
        $this->m_country["CV"]["nl"] = Adapto_html_entity_decode("Kaapverdi&euml;");
        ...
        $this->m_country["ET"]["nl"] = Adapto_html_entity_decode("Ethiopi&euml;");
        ...
        $this->m_country["FO"]["nl"] = Adapto_html_entity_decode("Faer&ouml;er");
        ...
        $this->m_country["GE"]["nl"] = Adapto_html_entity_decode("Georgi&euml;");
        ...
        $this->m_country["HT"]["nl"] = Adapto_html_entity_decode("Ha&iuml;ti");
        ...
        $this->m_country["ID"]["nl"] = Adapto_html_entity_decode("Indonesi&euml;");
        ...
        $this->m_country["IL"]["nl"] = Adapto_html_entity_decode("Isra&euml;l");
        ...
        $this->m_country["JO"]["nl"] = Adapto_html_entity_decode("Jordani&euml;");
        ...
        $this->m_country["KG"]["nl"] = Adapto_html_entity_decode("Kirgizi&euml;");
        ...
        $this->m_country["LY"]["nl"] = Adapto_html_entity_decode("Libi&euml;");
        ...
        $this->m_country["MY"]["nl"] = Adapto_html_entity_decode("Maleisi&euml;");
        ...
        $this->m_country["MR"]["nl"] = Adapto_html_entity_decode("Mauritani&euml;");
        ...
        $this->m_country["MD"]["nl"] = Adapto_html_entity_decode("Moldavi&euml;");
        ...
        $this->m_country["MN"]["nl"] = Adapto_html_entity_decode("Mongoli&euml;");
        ...
        $this->m_country["NA"]["nl"] = Adapto_html_entity_decode("Namibi&euml;");
        ...
        $this->m_country["PF"]["nl"] = Adapto_html_entity_decode("Frans-Polynesi&euml;");
        ...
        $this->m_country["SA"]["nl"] = Adapto_html_entity_decode("Saoedi-Arabi&euml;");
        ...
        $this->m_country["SO"]["nl"] = Adapto_html_entity_decode("Somali&euml;");
        ...
        $this->m_country["SY"]["nl"] = Adapto_html_entity_decode("Syri&euml;");
        ...
        $this->m_country["UA"]["nl"] = Adapto_html_entity_decode("Oekra&iuml;ne");
