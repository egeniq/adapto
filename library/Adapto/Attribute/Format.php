...
/**
 * The Adapto_Attribute_Format can be used to edit a formatted string.
 *
 * @author ijansch
 * @package adapto
 * @subpackage attributes
 */
class Adapto_Attribute_Format extends Adapto_Attribute
{
    public $m_format = ""; // defaulted to public
    public $m_breakdownCached = array(); // defaulted to public

    /**
     * Constructor
     *
     * <b>Example:</b>
     *        $this->add(new Adapto_Attribute_Format("license", "AAA/##/##",
     *                                                        AF_OBLIGATORY));
     *
