 ...
 * <i>Example usages</i>
 *
 * $this->add(new Adapto_Attribute_MlWrapper(new Adapto_Attribute("name")));
 *
 * @author ijansch
 * @package adapto
 * @subpackage attributes
 *
 */
class Adapto_Attribute_MlWrapper extends Adapto_Attribute
{
    public $m_childList = array(); // defaulted to public
     ...
     * @param integer $flags
     * @return Adapto_Attribute_MlWrapper
     */

    public function __construct(&$attribute, $flags = 0)
    {
