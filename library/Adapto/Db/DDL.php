...
class Adapto_Db_DDL
{
    public $m_table = array(); // defaulted to public
    public $m_fields = array(); // defaulted to public
    public $m_remove_field; // defaulted to public
    public $m_indexes = array(); // not yet implemented // defaulted to public
    public $m_primarykey = array(); // defaulted to public
    ...
    /**
     * Static factory method for creating a new Adapto_Db_DDL instance. This static
     ...
     * @return Adapto_Db_DDL instance of db specific DDL driver
     */
    function &create($database = NULL)
    {
        ...
        $filename = Adapto_Config::getGlobal("atkroot") . "atk/db/class.atk" . $database . "ddl.inc";
    ...
    function addField($name, $generictype, $size = 0, $flags = 0, $default = NULL)
    {
        ...
        $this->m_fields[$name] = array("type" => $generictype, "size" => $size, "flags" => $flags, "default" => $default);
    }
