 ...
 * @subpackage db
 */
class Adapto_Db_Mysql extends Adapto_Db
{
    ...
    public $m_type = "mysql"; // defaulted to public
    ...
    {
        /* goto next record */
        $this->m_record = @mysql_fetch_array($this->m_query_id, MYSQL_ASSOC | Adapto_Config::getGlobal("mysqlfetchmode"));
        $this->m_row++;
        $this->m_errno = mysql_errno();
        $this->m_error = mysql_error();
