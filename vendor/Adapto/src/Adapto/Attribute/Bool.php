 ...
 * the module/entity prefixes). Don't forget to add the AF_BLANK_LABEL flag
...
/**
 * The Adapto_Attribute_Bool class represents an attribute of an entity
 ...
 *
 */
class Adapto_Attribute_Bool extends Adapto_Attribute
{
    /**
     * Constructor
    ...
    function edit($record = "", $fieldprefix = "", $mode = "")
    {
        ...
        $result = '<input type="checkbox" id="' . $id . '" name="' . $id . '" value="1" ' . $onchange . $checked . ' '
                . $this->getCSSClassAttribute("atkcheckbox") . ' />';
