...
if (!Adapto_Config::getGlobal('meta_caching')) {
...
class Adapto_Db
{
     ...
     * @var String
     */
    public $m_host = ""; // defaulted to public
     ...
     * @var String
     */
    public $m_database = ""; // defaulted to public
     ...
     * @var String
     */
    public $m_password = ""; // defaulted to public
     ...
     * @var String
     */
    public $m_port = ""; // defaulted to public
     ...
     * @var String
     */
    public $m_charset = ""; // defaulted to public
     ...
     * @var String
     */
    public $m_collate = ""; // defaulted to public
     ...
     * @var String
     */
    public $m_connection = ""; // defaulted to public
     ...
     * @var int
     */
    public $m_row = 0; // defaulted to public
     ...
     * @var int
     */
    public $m_errno = 0; // defaulted to public
     ...
     * @var String
     */
    public $m_error = ""; // defaulted to public
     ...
     * @var boolean
     */
    public $m_haltonerror = true; // defaulted to public
     ...
     * @var String
     */
    public $m_type = ""; // defaulted to public
     ...
     * @var String
     */
    public $m_vendor = ""; // defaulted to public
     ...
     * @var int
     */
    public $m_affected_rows = 0; // defaulted to public
     ...
     * @var array
     */
    public $m_tableMeta = array(); // defaulted to public
     ...
     * @var Resource
     */
    public $m_link_id = 0; // defaulted to public
     ...
     * @var Resource
     */
    public $m_query_id = 0; // defaulted to public
     ...
     * @var boolean
     */
    public $m_auto_free = true; // defaulted to public
     ...
     * @var array
     */
    public $m_user_error = array(); // defaulted to public

    /**
     * Internal use; error messages from language files are cached here
     * @access private
     */
    public $m_errorLookup = array(); // defaulted to public
    ...
    {
        Adapto_Db::_getOrUseMapping($mapping);
    }
    ...
    {
        return Adapto_Db::_getOrUseMapping();
    }
    ...
    {
        Adapto_Db::_getOrUseMapping(NULL);
    }
    ...
    function errorLookup($errno)
    {
        if (count($this->m_errorLookup) == 0) {
            $filename = Adapto_Config::getGlobal("atkroot") . "atk/db/languages/" . $this->m_vendor . "_" . Adapto_Config::getGlobal('language') . '.lng';
    ...
    function getErrorMsg()
    {
        ...
        if ($errno == DB_UNKNOWNERROR) {
            ...
            case DB_ACCESSDENIED_DB:
                $tmp_error = sprintf(atktext("db_access_denied_database", "atk"), $this->m_user, $this->m_database);
                break;
            case DB_ACCESSDENIED_USER:
                $tmp_error = sprintf(atktext("db_access_denied_user", "atk"), $this->m_user, $this->m_database);
                break;
            case DB_UNKNOWNDATABASE:
                $tmp_error = sprintf(atktext("db_unknown_database", "atk"), $this->m_database);
                break;
            case DB_UNKNOWNHOST:
                $tmp_error = sprintf(atktext("db_unknown_host", "atk"), $this->m_host);
                break;
            }
    ...
    private function _getTableMetaFromCache($table)
    {
        ...
        $tmpfile = new Adapto_TmpFile('tablemeta/' . $this->m_connection . "/" . $table . ".php");
    ...
    {
        if ($format == "")
            $format = Adapto_Config::getGlobal("date_to_char", "Y-m-d");
     ...
     *
     * @param Adapto_Db $otherDb other database instance
     */
     ...
     * @return Adapto_Db Instance of the database class.
     */
    ...
    function &setInstance($name, &$db)
    {
        ...
        $name = Adapto_Db::getTranslatedDatabaseName($name);
