 ...
 *
 */
class Adapto_Db_Oci9 extends Adapto_Oci8Db
{
    public $m_bindresult = array(); // defaulted to public

    public $m_type = "oci9"; // defaulted to public

    // Defaults
    public $m_port = "1521"; // defaulted to public
 ...
 {
                $db = "(DESCRIPTION=(ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = " . $this->m_host . ")(PORT = " . $this->m_port
                        . ")))(CONNECT_DATA=(SID=" . $this->m_database . ")))";
            } else {
