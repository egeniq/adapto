...
/**
 * Implementation of many-to-many relationships using a shuttle for metan entitys.
 *
 * @author petercv
 * @package adapto
 * @subpackage meta.relations
 */ 
class Adapto_Meta_Relation_MetaExtendableShuttle extends Adapto_ExtendableShuttleRelation
{
