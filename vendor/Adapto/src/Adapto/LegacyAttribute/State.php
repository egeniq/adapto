...
/**
 * The Adapto_Attribute_State class represents an attribute to handle United States in a listbox.
 * It extends Adapto_ListAttribute.
 *
 * @author Kevin Lwinmoe <kevin.lwinmoe@gmail.com>
 * @package adapto
 * @subpackage attributes
 */
class Adapto_Attribute_State extends Adapto_ListAttribute
{
    public $m_states = array(); // defaulted to public

    public $m_usa_states = array('AL', 'AK', 'AS', 'AZ', 'AR', 'CA', 'CO', 'CT', 'DE', 'DC', 'FM', 'FL', 'GA', 'GU', 'HI', 'ID', 'IL', 'IN', 'IA', 'KS', 'KY', // defaulted to public
            'LA', 'ME', 'MH', 'MD', 'MA', 'MI', 'MN', 'MS', 'MO', 'MT', 'NE', 'NV', 'NH', 'NJ', 'NM', 'NY', 'NC', 'ND', 'MP', 'OH', 'OK', 'OR', 'PW', 'PA',
     ...
     * Constructor
     * <b>Example:</b>
     * $this->add(new Adapto_Attribute_State("state_abbrev", AF_OBLIGATORY | AF_SEARCHABLE));
    ...
    public function __construct($name, $switch = "usa", $optionArray = "", $valueArray = "", $flags = 0, $defaulttocurrent = true)
    {
