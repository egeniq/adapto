...
/**
 * The Adapto_Attribute_Fck is a 'wysiwyg' text editor.
 *
 ...
 *
 */
class Adapto_Attribute_Fck extends Adapto_TextAttribute
{
    public $m_editorname = ""; // defaulted to public
    public $m_urlpath = ""; // defaulted to public
    public $fck_opt = array('ToolbarSet' => 'Default', 'Width' => '100%', 'Height' => '300px'); // defaulted to public
    ...
    public function __construct($name, $size = '', $flags = 0, $opt = array())
    {
