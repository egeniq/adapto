 ...
 *
 */
class Adapto_Util_TableRenderer
{
    public $m_cellalignment = array(); // defaulted to public
    public $m_rowalignment = array(); // defaulted to public
    public $m_colalignment = array(); // defaulted to public
    public $m_span = array(); // defaulted to public
    public $m_defaultalignment = TBL_LEFT; // defaulted to public
    public $m_cellclass = array(); // defaulted to public
    public $m_rowclass = array(); // defaulted to public
    public $m_colclass = array(); // defaulted to public
    public $m_defaultclass = ""; // defaulted to public
    public $m_maxWidth = 0; // defaulted to public
    public $m_flags = 0; // defaulted to public
    public $m_style = ''; // defaulted to public
    public $m_tableMatrix = null; // defaulted to public
    ...
    public function __construct($flags = 0, $style = '', $module = '')
    {
        $this->m_flags = $flags;
    ...
    {
        if (array_key_exists($row, $this->m_span) && array_key_exists($col, $this->m_span[$row]) && is_array($this->m_span[$row][$col]))
