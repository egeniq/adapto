<?php
   ...
   *
   */
  class Adapto_Security_Encryption_OpenSSL extends Adapto_Encryption
  {
    public $m_config_default; // defaulted to public
    public $m_config_nokey; // defaulted to public
    public $m_backslashreplacestring = "*bs*"; // defaulted to public
