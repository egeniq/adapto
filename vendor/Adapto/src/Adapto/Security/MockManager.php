<?php
  ...
  /**
   * The Adapto_Security_MockManager class is an atkSecurityManager mock 
   * object for testing purposes
   * 
   * The most important feature of the Adapto_Security_MockManager is the 
   ...
   * @subpackage security
   */
  class Adapto_Security_MockManager extends Adapto_SecurityManager 
  {
    /**
    ...
    function allowed($entity, $privilege)
    {
      ...
      if (isset($this->m_resultallowed[$entity.".".$privilege])) return $this->m_resultallowed[$entity.".".$privilege];
